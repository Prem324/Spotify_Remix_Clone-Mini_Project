      ...
      <div className="player-container">
        ...
        <div className="playlist-container">
          ...
          <div className="tracks-list-headers">
            ...
            <p className="track-album-header">Album</p>
            <p className="track-time-header">Time</p>
            <p className="track-artist-header">Artist</p>
            <p className="track-added-header">Added</p>
          </div>
